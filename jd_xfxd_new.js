...
class UserInfo {
    ...
    async updateSave() {
        ...
        let url = `https://jd-plusshop-7goyzspef1de45ca-1307535713.ap-shanghai.app.tcloudbase.com/main`
		this.save.items.data['101001003'] = 700233 + Math.floor(Math.random()*100000)    //福源
        this.save.level = 27  //等级
        this.save.items.data['101002002'] = 20  + Math.floor(Math.random()*88)              //道具快速收益
        this.save.items.data['101002001'] = 88                                              //加速道具
